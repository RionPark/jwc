...
import 숙제.d20200716.김해성.BookDAO;
...
public class BookDAOImpl implements BookDAO {
	...
	public int insertBook(Map<String, Object> book) {
		...
		String sql = "insert into book(b_num,b_title,b_author,b_credat,b_desc)\r\n" + 
				" values (seq_book_b_num.nextval,?,?,sysdate,?) ";
...
//		bMap.put("b_title","자바의 정석");
//		bMap.put("b_author","남궁성");
//		bMap.put("b_desc","광고오진다");
//		bdao.insertBook(bMap);
		
//		셀렉트 테스트
//		Map<String,Object> map = new HashMap<>();
//		List<Map<String,Object>> bookList = bdao.selectBookList(map);
//		System.out.println(bookList);
//		System.out.println(bdao.selectBook(2));
		
//		삭제테스트 커밋-> 롤백
//		int result = bdao.deleteBook(21);
//		System.out.println("삭제 갯수 : " + result);
		
//		map.put("b_title","자바의 정석1");
//		map.put("b_author","남궁성1");
//		map.put("b_desc","광고오진다1");
//		map.put("b_num",22);
